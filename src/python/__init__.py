...
for name in ['core', 'core.xml', 'core.warp', 'core.math', 'core.spline', 
             'render', 'render.mueller',
             'geometry',
            ]:
    name = 'mitsuba.' + name
...
geometry = sys.modules['mitsuba.geometry']
...
def set_variant(value):
    ...
    try:
        modules = {
            ...
            'mitsuba.geometry' : (_import('mitsuba.geometry_ext'),
                                  _import('mitsuba.geometry_' + value + '_ext')),
        }
    except ImportError as e:
